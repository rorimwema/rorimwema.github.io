...
**[Flowy](/projects/flowy/)** — A Telegram mini app for money and commerce. Making payments simple inside the app you already use.

**[Lisp Interpreter](/projects/nvim-config/)** — In OCaml, because every programmer needs to write a Lisp at least once.
...
- **Editor**: Neovim with my own [config](/projects/nvim-config/)
